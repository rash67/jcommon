    ...
    return new Object[][]{
        {
            ...
            new DateTime(2011, 3, 13, 0, 29, 10, 102, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.SECOND, 1),
            new DateTime(2011, 3, 13, 0, 29, 11, 101, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.MINUTE, 5),
            new DateTime(2011, 3, 13, 0, 34, 10, 101, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.MINUTE, 121),
            new DateTime(2011, 3, 13, 3, 30, 10, 101, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.HOUR, 2),
            new DateTime(2011, 3, 13, 3, 29, 10, 101, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.DAY, 1),
            new DateTime(2011, 3, 14, 0, 29, 10, 101, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.MONTH, 3),
            new DateTime(2011, 6, 13, 0, 29, 10, 101, PDT),
            1
        },
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.WEEK, 7),
            new DateTime(2011, 5, 1, 0, 29, 10, 101, PDT),
            1
        },
        // Tests out leap years too
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.YEAR, 5),
            new DateTime(2016, 3, 13, 0, 29, 10, 101, PDT),
            1
        },
        // Test multiple > 1
        {
            testTime,
            TimeInterval.withTypeAndLength(TimeIntervalType.MINUTE, 60),
            new DateTime(2011, 3, 13, 3, 29, 10, 101, PDT),
            2
        },
        // Test exact instant of transition
        {
            new DateTime(2011, 3, 13, 1, 59, 59, 999, PDT),
            TimeInterval.withTypeAndLength(TimeIntervalType.MILLIS, 1),
            new DateTime(2011, 3, 13, 3, 0, 0, 0, PDT),
            1
        },
