 ...
 * <dl>
 * <dt>{@link #out}</dt>
 * <dd>A {@link com.samrash.tools.io.StatusPrintStream} instance for stdout-like output</dd>
 * <dt>{@link #err}</dt>
 * <dd>A {@link com.samrash.tools.io.PrintStreamPlus} instance for stderr-like output</dd>
 * <dt>{@link #in}</dt>
 * <dd>A {@link com.samrash.tools.io.Input} instance for stdin-like input</dd>
 * </dl>
 * <p/>
 ...
 * consecutive {@link com.samrash.tools.io.Status} methods overwrite previous ones, making them
...
public class IO
{
   ...
   * its members annotated with {@link com.samrash.tools.io.Answer}. The first
   * {@link com.samrash.tools.io.Answer#value()} is show in the brackets after the prompt, but any
